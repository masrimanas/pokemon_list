...
mixin _$PokemonListState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Pokemon> data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Pokemon> data)? success,
...
class _$_Success implements _Success {
  const _$_Success(final List<Pokemon> data) : _data = data;
  ...
  @override
  String toString() {
    return 'PokemonListState.success(data: $data)';
  }
...
abstract class _Success implements PokemonListState {
  const factory _Success(final List<Pokemon> data) = _$_Success;
...
class _$_Error implements _Error {
  ...
  @override
  String toString() {
    return 'PokemonListState.error(errorMessage: $errorMessage)';
  }
